...
public class WaveProgressView extends View {
  ...
  private void initView(Context cxt, AttributeSet attrs) {
    ...
    int mainTextColor = ta.getInt(R.styleable.WaveViewStyle_mainTextSize, 0xFFFFFF);
    int mainTextSize = ta.getDimensionPixelSize(R.styleable.WaveViewStyle_mainTextSize, 40);
    ta.recycle();
    ...
    mPaintBorderCircle.setColor(mainTextColor);
